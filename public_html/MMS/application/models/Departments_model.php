...
class Departments_model extends App_Model
{
    ...
    public function get_staff_departments($userid = false, $onlyids = false)
    {
        ...
        if ($onlyids == false) {
            ...
            $this->db->select(db_prefix() . 'merchant_departments.departmentid');
        }
        $this->db->from(db_prefix() . 'merchant_departments');
        $this->db->join(db_prefix() . 'departments', db_prefix() . 'merchant_departments.departmentid = ' . db_prefix() . 'departments.departmentid', 'left');
        $this->db->where('merchid', $userid);
