...
*
*/
define('APP_BASE_URL', 'https://user.bearlapay.com/MMS/');
...
*/
define('APP_ENC_KEY', '960813ca204698c99eb96a7c4e592852');
 ...
 */
define('APP_DB_USERNAME', 'bearlapay_admin');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'O4rQajSvmuxHQ2JT');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'admin_bearlapay');
