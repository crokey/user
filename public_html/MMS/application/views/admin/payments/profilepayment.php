...
if ($payment->transaction_type == 'FX') {
    ...
    echo render_input('text', 'transaction_amount_to', $payment->exchange_amount_to, 'number', ['readonly' => 'readonly', 'style' => 'color: #000000;']); 
    ...
    echo render_input('text', 'transaction_amount', $payment->amount, 'number', ['readonly' => 'readonly', 'style' => 'color: #000000;']);   
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 mtop40">
                          ...
                          if ($payment->transaction_type == 'Withdraw' || $payment->transaction_type == 'Transfer(In)') { 
                            ...
                            echo '<div class="payment-preview-wrapper">';
                            	echo _l('payment_total_amount'); echo'<br>';
                            	echo ($payment->exchange_amount_to);
                            echo '</div>';
                          }
                            ?>
                                </div>
