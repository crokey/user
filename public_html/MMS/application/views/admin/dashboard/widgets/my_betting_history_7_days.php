...
<div class="widget" id="widget-my_betting_history_7_days" data-name="My Last 7 Days Betting History">
    ...
    <div class="panel_s">
        <div class="panel-body padding-10">
            ...
            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 tw-p-1.5">
                ...
                <span class="tw-text-neutral-700">My Last 7 Days Betting History</span>
            </p>
            <hr class="-tw-mx-3 tw-mt-3 tw-mb-3">

            <?php if (!empty($my_betting_history_7_days)) : ?>
                <ul class="list-group" style="overflow: visible;">
    <?php foreach ($my_betting_history_7_days as $tip): 
