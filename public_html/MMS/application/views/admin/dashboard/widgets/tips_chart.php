...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="Tips Win/Loss">
            ...
            <div class="panel_s">
                <div class="panel-body padding-10">
                    ...
                    <div class="relative" style="height:250px">
                        <canvas class="chart" height="130" id="tips_win_loss_chart"></canvas>
                    </div>
                </div>
            </div>
        </div>
