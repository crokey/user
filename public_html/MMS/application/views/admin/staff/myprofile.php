...
<div id="wrapper">
    <div class="content">
        <?php if (($staff_p->id == get_staff_user_id() || is_admin()) && !$this->input->get('notifications')) { ?>
        <div class="mbot30">
        ...
        <div class="row">
            ...
            <div class="col-md-5<?php echo $this->input->get('notifications') ? ' hide' : ''; ?>">
                <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700 tw-inline-flex tw-items-center">
                    <?php echo staff_profile_image($staff_p->id, ['staff-profile-image-small tw-mr-2'], 'small'); ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tw-flex">
                            ...
                            <div class="tw-space-x-0.5">
                                ...
                                <a href="<?php echo admin_url('staff/member/' . $staff_p->id); ?>"
                                    class="btn btn-default btn-icon">
                        ...
                        <div class="panel-table-full">
                            <div class="_filters _hidden_inputs hidden staff_projects_filter">
                                <?php echo form_hidden('staff_id', $staff_p->id); ?>
                            </div>
            ...
            <?php if ($staff_p->id == get_staff_user_id()) { ?>
