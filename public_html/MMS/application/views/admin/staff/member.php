    ...
    echo ' hide';
                              ...
                              ?>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <?php echo staff_profile_image($member->id, ['img', 'img-responsive', 'staff-profile-image-thumb'], 'thumb'); ?>
                                        </div>
                                        <div class="col-md-3 text-right">
                                            <a
                                                href="<?php echo admin_url('staff/remove_staff_profile_image/' . $member->id); ?>"><i
                                ...
                                <?php $rel_id = (isset($member) ? $member->id : false); ?>
                                ...
                                <div class="row" style="display: none;">
                                    <div class="col-md-12">
                                        ...
                                        <div class="checkbox checkbox-primary">
                                            <?php
                                 $isadmin = '';
                                 if (isset($member) && ($member->id == get_staff_user_id() || is_admin($member->id))) {
                                     $isadmin = ' checked';
                                 }
                              ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="mbot15 usernote hide inline-block full-width">
                            <?php echo form_open(admin_url('misc/add_note/' . $member->id . '/staff')); ?>
