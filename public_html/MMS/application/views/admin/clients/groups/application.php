...
$subFolderName = 'view/application/';

// If the folder parameter is set in the URL, decode it to handle spaces consistently
...
$currentUrl = "https://user.bearlapay.com/MMS/admin/clients/client/{$clientId}?group=application";
