...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        [
            'path'      => 'admin/dashboard/widgets/todays_tips',
            'container' => 'left-8', // You can use: top-12, left-8, right-4, etc.
        ],

        [
            'path'      => 'admin/dashboard/widgets/tips_chart',
            'container' => 'right-4', // You can use: top-12, left-8, right-4, etc.
        ],

        [
            'path'      => 'admin/dashboard/widgets/bettings_history_7_days',
            'container' => 'right-4', // You can use: top-12, left-8, right-4, etc.
        ],

        [
            'path'      => 'admin/dashboard/widgets/my_betting_history_7_days',
            'container' => 'right-4', // You can use: top-12, left-8, right-4, etc.
        ],

        [
            'path'      => 'admin/dashboard/widgets/win_rate_summary',
            'container' => 'left-8', // You can use: top-12, left-8, right-4, etc.
        ],
