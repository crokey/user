...
function _init_admin_assets()
{
    ...
    $CI->app_css->add('phosphor-icons', 'https://unpkg.com/@phosphor-icons/web@2.0.3/src/regular/style.css', 'admin');
    ...
    $CI->app_css->add('app-css', base_url($CI->app_css->core_file('assets/css', 'style.css')) . '?v=' . time(), 'admin', ['tailwind-css']);
