...
class Staff extends AdminController
{
            ...
            if ($id == '') {
                ...
                if (is_array($response)) {
                    if (isset($response['cant_remove_main_admin'])) {
                        set_alert('warning', _l('merch_cant_remove_main_admin'));
                    } elseif (isset($response['cant_remove_yourself_from_admin'])) {
                        set_alert('warning', _l('merch_cant_remove_yourself_from_admin'));
                    }
    ...
    {
        $data['view_all'] = false;
        if (merch_can('view-timesheets', 'reports') && $this->input->get('view') == 'all') {
    ...
    public function remove_staff_profile_image($id = '')
    {
        ...
        if (is_numeric($id) && (merch_can('create',  'staff') || merch_can('edit',  'staff'))) {
            $staff_id = $id;
        }
