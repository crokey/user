                        ...
                        if (is_array($groups) && !empty($groups)) {
                            foreach ($groups as $group) : ?>
                                <li id="<?= $group['group_id'] ?>">
                                    <img class="_group_image" src="<?= module_dir_url('chat', 'assets/chat_implements/icons/groups.png'); ?>" data-toggle="tooltip" data-title="<?= $group['group_name'] ?>">
...
<script>
    ...
    $("body").on("keyup", '#_searchUsers', _debounce(function(e) {
        ...
        if (value.length) {
            ...
            if (searchInDatabase) {
                ...
                $.getJSON("<?php echo site_url('chat/chat_Controller/searchStaffForForward'); ?>", {
    ...
    function appendNextStaff(el) {
        ...
        if (el.scrollTop() + el.innerHeight() >= el[0].scrollHeight) {
            ...
            $.getJSON("<?php echo site_url('chat/chat_Controller/appendMoreStaff'); ?>", {
