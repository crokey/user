        ...
        navigator.mediaDevices.getUserMedia(constraints).then(function (stream) {
            ...
            */
            ...
            recorder = new WebAudioRecorder(input, {
                workerDir: site_url + "/modules/chat/assets/js/audio/", // must end with slash
            ...
            recorder.onComplete = function (recorder, blob) {
                ...
                reader.onloadend = function () {
                    ...
                    if (typeof admin_url == "undefined") {
                        url = site_url + "chat/chat_ClientsController/handleAudio"
                    } else {
                        url = admin_url + "chat/chat_Controller/handleAudio";
                    }

                    $.post(url, {"audio": base64data}, function (res) {
                        if (res.filename) {

                            var audio = '<audio controls src="' + site_url + 'modules/chat/uploads/audio/' + res.filename + '" type="audio/ogg"></audio>';
