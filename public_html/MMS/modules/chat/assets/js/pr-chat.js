    ...
    $.get(prchatSettings.usersList, function (data) {
        ...
        $.each(data, function (user_id, value) {
            ...
            fullName = nameReplacements[fullName] || fullName;
                ...
                if (user != null) {
                    onlineUser += "<a data-status=\"" + value.status + "\" data-toggle=\"tooltip\" title=\"" + translated_status + "\" href=\"#" + value.staffid + "\" id=\"" + value.staffidid + "\" class=\"on " + value.status + "\"><span class=\"user-name onlineUsername\">" + fullName + "</span><img src=\"" + fetchUserAvatar(value.staffid, value.profile_image) + "\" class=\"imgFriend\" /></a>";
                    ...
                    offlineUser += " data-toggle=\"tooltip\" title=\"" + "\">";
                    offlineUser += "<span class=\"user-name\">" + fullName + "</span><img src=\"" + fetchUserAvatar(value.staffid, value.profile_image) + "\" class=\"imgOther\" /></a>";
                }
            }
        });
...
/*---------------* Sound functions *---------------*/
var getSound = new Audio(site_url + "modules/chat/assets/chat_implements/sounds/push.mp3");
var getSeenSound = new Audio(site_url + "modules/chat/assets/chat_implements/sounds/chat_seen.mp3");
...
const deleteUrl = admin_url + "chat/chat_Controller/purgeConversations";
