     ...
     <div class="message-input">
          <div class="wrap">
            ...
            <textarea  type="text" disabled name="msg" class="chatbox ays-ignore" placeholder="<?= _l('chat_type_a_message'); ?>"></textarea>
               ...
               <input type="hidden" class="ays-ignore from" name="from" value="client_" />
               <input type="hidden" class="ays-ignore to" name="to" value="staff_" />
               ...
               <button id="sendMessageBtn" class="submit enterBtn" name="enterBtn"><svg class="fa-paper-plane" fill="#ffffff" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var messages = document.querySelector('.messages'); // Define messages here to ensure it's accessible
